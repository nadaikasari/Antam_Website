    ...
    <div class="col-xl-10 col-lg-7">
        <div class="card shadow mb-4">
            <div
                ...
                <h6 class="m-0 font-weight-bold text-primary">Form Penambahan Produk Perak</h6>
            </div>
            <div class="container" id="isi" >
            <form method="post" action="../class-produk/operasi-perak.php?action=add" enctype="multipart/form-data">
                <br>
                <?php 
