...
<html lang="en">
  <head>
    ...
    <?php
    if(@$_GET['page'] == 'kontak-kami') {
      ?>   <link rel="stylesheet" href="../css/style.css">
      <?php
      include "kontak-kami.php";
    }

    elseif(@$_GET['page'] == 'produk-emas') {
      ?> <link rel="stylesheet" href="css/produk.css">
      <?php
      include "produk-emas.php";
    }
    
    elseif(@$_GET['page'] == 'produk-perak') {
      ?> <link rel="stylesheet" href="css/produk.css">
      <?php
      include "produk-perak.php";
    }

    elseif(@$_GET['page'] == 'produk-semua') {
      ?> <link rel="stylesheet" href="css/produk.css">
      <?php
    ...
    elseif(@$_GET['page'] == 'profile') {
      ...
      <?php
      include "profile-konsumen.php";
    }

    elseif(@$_GET['page'] == 'riwayat') {
      ?>
      <?php
      include "riwayat-pemesanan.php";
    }
    ?>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="?page=beranda">Home <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item dropdown">
                ...
                <a class="dropdown-item" href="?page=produk-emas">Emas Murni</a>
                <a class="dropdown-item" href="?page=produk-perak">Perak Murni</a>
                </div>
            </li>
            
            <li class="nav-item">
                <a class="nav-link" href="?page=menunggu-konfirmasi">Riwayat Pesanan</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="?page=kontak-kami">Kontak Kami</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="?page=tentang">Tentang</a>
            </li>
            <div class="icon mt-2"> <a href="?page=cart" style="color: #DAA520;">
    ...
    <div class="container-fluid">
        ...
        <?php
            ...
            elseif(@$_GET['page'] == 'menunggu-konfirmasi') {
              include "menunggu-konfirmasi.php";
            }
            elseif(@$_GET['page'] == 'diproses') {
              include "diproses.php";
            }

            elseif(@$_GET['page'] == 'dikirim') {
              include "dikirim.php";
            }

            elseif(@$_GET['page'] == 'selesai') {
              include "selesai.php";
            }

            elseif(@$_GET['page'] == 'daftar-pembayaran') {
              include "daftar-pembayaran.php";
            }

            elseif(@$_GET['page'] == 'list-artikel') {
              include "list-artikel.php";
            }
        ?>
    </div>
    <!-- /.container-fluid -->
    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-md-4 footer-column">
        ...
        <ul class="nav flex-column">
          <li class="nav-item">
            <a class="nav-link text-light" href="?page=produk-emas">Beli Emas</a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-light" href="?page=produk-perak">Beli Perak</a>
          </li>
        </ul>
      </div>
      ...
      <div class="col-lg-3 col-md-4 footer-column">
        ...
        <ul class="nav flex-column">
        <li class="nav-item">
            <a class="nav-link text-light" href="?page=profile">Akun Saya</a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-light" href="?page=kontak-kami">Kontak Kami</a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-light" href="?page=tentang">Tentang Kami</a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-light" href="?page=list-artikel">Berita dan Promo</a>
          </li>
        </ul>
      </div>
